...
public class StringIntro {
    public static void main(String[] args) {
        ...
        System.out.println("--------------------------------------");
        // if we have compare the visible string (sequence characters)
        String s1 = "Java";
        String s2 = new String("Java");
        System.out.println(s1.equals(s2));  // we will use equals methods

        String s3 = "Java";
        String s4 = new String("java");
        System.out.println(s3.equals(s4));  // false because java is lower case.
