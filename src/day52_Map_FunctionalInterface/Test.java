...
public class Test {
    public static void main(String[] args) {
        ...
        //function2: create a function that can check if a person is eligible buy alcohol
        ...
        divisible3and5 = n -> {
            if (n % 15 == 0) {
                System.out.println(n + " is divisible3 and 5  ");
            } else System.out.println(n + " is not divisible 3 and 5");
        };
        divisible3and5.apply(11);
